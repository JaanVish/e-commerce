            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="primary_input mb-25">
                    ...
                    <input name="title" class="primary_input_field name"
                        ...
                        type="text" required value="{{$repair->title}}">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="primary_input mb-25">
                    ...
                    <input name="slug" class="primary_input_field slug"
                        ...
                        type="text" required value="{{$repair->slug}}">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="primary_input mb-25">
                    ...
                    <input name="icon" class="primary_input_field icon"
                        ...
                        type="text" required autocomplete="off" value="{{$repair->icon}}">
                    ...
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option"
                                ...
                                <input name="status" id="status_active" value="1" {{$repair->status == 1?'checked':''}} class="active" type="radio">
                        ...
                        <li>
                            <label data-id="color_option"
                                   class="primary_checkbox d-flex mr-12">
                                <input name="status" value="0" id="status_inactive" {{$repair->status == 0?'checked':''}}  class="de_active"
                                       type="radio">
                                <span class="checkmark"></span>
                            </label>
