...
use App\Http\Middleware\AdminMiddleware;
    Route::middleware([AdminMiddleware::class])->prefix('frontendcms')->as('frontendcms.')->group(function() {
        ...
        Route::post('/features/delete','FeatureController@delete')->name('features.delete')->middleware('prohibited_demo_mode');
         ...
         Route::post('/repairs/store','RepairController@store')->name('repairs.store')->middleware('prohibited_demo_mode');
         Route::get('/repairs/edit/{id}','RepairController@edit')->name('repairs.edit');
         Route::post('/repairs/update/','RepairController@update')->name('repairs.update')->middleware('prohibited_demo_mode');
         Route::post('/repairs/delete','RepairController@delete')->name('repairs.delete')->middleware('prohibited_demo_mode');       
